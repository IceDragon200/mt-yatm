...
dofile(yatm_dscs.modpath .. "/nodes/void_chest.lua")
dofile(yatm_dscs.modpath .. "/nodes/void_crate.lua")
dofile(yatm_dscs.modpath .. "/nodes/digitizer.lua")
dofile(yatm_dscs.modpath .. "/nodes/materializer.lua")
dofile(yatm_dscs.modpath .. "/nodes/inventory_monitor.lua")
