minetest.register_craftitem("yatm_dscs:fluid_drive_t1", {
  ...
  inventory_image = "yatm_inventory_drives_tier1_fluid.png",
})
...
minetest.register_craftitem("yatm_dscs:fluid_drive_t2", {
  ...
  inventory_image = "yatm_inventory_drives_tier2_fluid.png",
})
...
minetest.register_craftitem("yatm_dscs:fluid_drive_t3", {
  ...
  inventory_image = "yatm_inventory_drives_tier3_fluid.png",
})
