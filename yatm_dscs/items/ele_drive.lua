...
minetest.register_craftitem("yatm_dscs:ele_drive_t1", {
  ...
  inventory_image = "yatm_inventory_drives_tier1_ele.png",
})
...
minetest.register_craftitem("yatm_dscs:ele_drive_t2", {
  ...
  inventory_image = "yatm_inventory_drives_tier2_ele.png",
})
...
minetest.register_craftitem("yatm_dscs:ele_drive_t3", {
  ...
  inventory_image = "yatm_inventory_drives_tier3_ele.png",
})
