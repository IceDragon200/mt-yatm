...
minetest.register_node("yatm_mesecon_locks:mesecon_card_reader_off", {
...
minetest.register_node("yatm_mesecon_locks:mesecon_card_reader_on", {
  description = "Card Reader (Mesecons)",
...
if yatm_data_network then
  ...
  minetest.register_node("yatm_mesecon_locks:data_card_reader_off", {
  ...
  minetest.register_node("yatm_mesecon_locks:data_card_reader_on", {
    description = "Card Reader (DATA)",
