...
yatm.devices.register_network_device(roller_yatm_network.states.off, {
  description = "Roller",
  groups = {cracky = 1},
...
yatm.devices.register_network_device(roller_yatm_network.states.error, {
  description = "Roller",
...
yatm.devices.register_network_device(roller_yatm_network.states.on, {
  description = "Roller",
  groups = {cracky = 1, not_in_creative_inventory = 1},
  drop = roller_yatm_network.states.off,
  tiles = {
