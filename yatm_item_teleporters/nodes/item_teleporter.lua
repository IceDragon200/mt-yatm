...
for _,state in ipairs(states) do
  ...
  minetest.register_node("yatm_item_teleporters:item_teleporter_" .. state, {
    ...
    tiles = {
      "yatm_item_teleporter_top.teleporter." .. state .. ".png",
      "yatm_item_teleporter_top.teleporter." .. state .. ".png",
      "yatm_item_teleporter_side.teleporter." .. state .. ".png",
      "yatm_item_teleporter_side.teleporter." .. state .. ".png",
      "yatm_item_teleporter_side.teleporter." .. state .. ".png",
      "yatm_item_teleporter_side.teleporter." .. state .. ".png",
    },
