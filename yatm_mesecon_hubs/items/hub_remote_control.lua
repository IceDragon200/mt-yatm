...
local function hub_remote_control_on_use(itemstack, user, pointed_thing)
  ...
  if is_blank(address) then
    -- Don't do shit.
    core.chat_send_player(user:get_player_name(), "No Target Address")
  else
    ...
    core.chat_send_player(user:get_player_name(), "Toggled " .. address .. " " .. new_state)
  end
  return itemstack
end

core.register_tool("yatm_mesecon_hubs:hub_remote_control", {
