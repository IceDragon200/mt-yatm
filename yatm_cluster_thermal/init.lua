...
local ClusterThermal = yatm_core.Class:extends("ClusterThermal")
local ic = ClusterThermal.instance_class
...
yatm.cluster.devices = ClusterThermal:new()

yatm.clusters:register_node_event_handler(CLUSTER_GROUP, yatm.cluster.devices:method('handle_node_event'))
yatm.clusters:observe('terminate', 'yatm_cluster_thermal:terminate', yatm.cluster.devices:method('terminate'))
